...
CameraControls::CameraControls(Widget* parent) : Widget(parent)
{
    ...
    perspectiveRadio->set_callback([&]() -> void { params.type = CameraParameters::CameraType::Perspective; });
    ...
    orthographicRadio->set_callback([&]() -> void { params.type = CameraParameters::CameraType::Orthographic; });
    ...
    auto autoAspect = new CheckBox(wrapper, "auto aspect",
                                   [&](bool b) -> void { autoAdjustFOV = b; });
