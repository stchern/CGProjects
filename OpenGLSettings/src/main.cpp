...
public:
                          ...
                          /* gl_minor */ 1}
    {
        ...
        // setup the scene
        {
            ...
            const Material boxWhite{Material::Diffuse{{0.6f, 0.6f, 0.6f}}};
            ...
            const Material roughGold{
                Material::RoughConductor{Material::Conductor{{0.143085f, 0.374852f, 1.44208f},
                                                             {3.98205f, 2.38506f, 1.60276f}},
                                         {0.1f}}};

            // selection of models...
            // TODO change materials if you wish
            scene.addInstance({"../meshes/bunny.obj",
                               diffuseGray,
                               {Matrix3D::scale(5.f), {0.0f, -0.17f, -0.5f}}});
            scene.addInstance({"../meshes/gdv.obj", diffuseBlue, {{}, {0.0f, 0.5f, -1.0f}}});
